...
<?php include 'header.php'; ?>
    ...
    <section class="recipient-intro intro mdev-main-wrapper">
      ...
      <p>The deadline for nominations is<br />
        <span>February 28th, 2018 at midnight EST</span></p>
        <p class="button-wrapper">
          <a href="#" class="rsp-btn rsp-btn-purple">Submit a nomination</a>
        </p>
      </div>
    </section>
    <section class="congratulate-banner">
      <p>Congratulations to the 2017 RSP Award Recipients!</p>
    ...
    <section class="national-recipient">
      ...
      <div class="recipient-wrapper">
        ...
        <div class="pullquote">
          ...
          2017 Regional Recipient, Western Canada</p>
          <p><a href="#" class="profile-link">Read Matthew's profile on Home Goods Online</a></p>
        </div>
      </div>
    </section>
    <section class="regional-recipients mdev-main-wrapper">
      <div class="recipient">
        ...
        <div class="pullquote">
          ...
          <p class="author"><span class="u-bold rsp-purple">Amanda Bell</span><br />
          2017 Regional Recipient, British Columbia</p>
      ...
      <div class="recipient">
        <div class="pullquote">
          ...
          <p class="author"><span>Sylvie Viel</span><br />
          2017 Regional Recipient, Eastern Canada</p>
          <p><a href="#" class="profile-link">Read Sylvie's profile on Home Goods Online</a></p>
        </div>
        <div class="image">
      ...
      <div class="recipient">
        ...
        <div class="pullquote">
          ...
          <p class="author"><span>Ruth Parkinson</span><br />
          2017 Regional Recipient, Ontario</p>
