...
<?php include 'header.php'; ?>
    ...
    <section class="rsp-intro mdev-main-wrapper flex flex-row flex-hor-between">
      <div class="intro-content">
        <h1>About</h1>
        <p>The RSP Awards recognize the sales professionals in Canada's Home Furnishings Industry who exceed the standards for excellence.</p>
    ...
    <section class="who mdev-main-wrapper">
      ...
      <div class="wrapper flex flex-row flex-hor-between">
        ...
        <div class="submission">
          <p>The deadline for nominations is<br />
          <span class="u-bold rsp-purple">February 28th, 2018 at midnight EST</span></p>
        ...
        <div class="wrapper flex flex-row flex-hor-between">
          ...
          <p class=" sub-heading u-bold rsp-purple">Candidates for nomination must meet the following minimum requirements:</p>
            <ul>
              ...
              <li>Consistently meets or exceeds performance goals as confirmed by the Candidate’s employer.</li>
              <li>Demonstrates a customer-focused approach with supported documentation.</li>
              <li>Mentors and assists other sales professionals as recognized and confirmed by their peers.</li>
            </ul>
          </div>
          <div class="additional">
            <p class="sub-heading u-bold rsp-purple">Additional considerations:</p>
            <p>Candidate must be aware of the nomination and be willing to be considered for this award. If selected, award recipients must be available to attend the Canadian Home Furnishings Awards Gala which will held on Friday, May 25, 2018 in Toronto, Ontario. Transportation and accommodations will be provided.</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="regions flex flex-row flex-hor-between">
        <div>
          ...
          <ul>
            ...
            <li>New Brunswick</li>
            <li>Nova Scotia</li>
            <li>Newfoundland &amp; Laborador</li>
            <li>Prince Edward Island</li>
          </ul>
          <h5>Canada Central</h5>
          <ul>
            <li>Ontario</li>
          </ul>
        </div>
        <div>
          <h5>Canada Prairies</h5>
          <ul>
            <li>Manitoba</li>
            <li>Saskatchewan</li>
            <li>Alberta</li>
      ...
      <div class="mdev-main-wrapper">
        ...
        <div class="wrapper flex flex-row flex-hor-between flex-vert-center">
          <div class="chosen-content">
            <p>All four regional recipients will receive an all-expense paid round-trip (travel, accommodation and meals) to Toronto. Recipients will be formally recognized and will receive their RSP Awards during the <a href="#">Canadian Home Furnishings Gala</a> on May 25, 2018. Following the gala, recipients will be profiled by Home Goods Online where their personal success stories will be published and featured. </p>
          </div>
    ...
    <section class="panel mdev-main-wrapper">
      ...
      <div class="panel-wrapper flex flex-row flex-hor-between">
        ...
        <div class="member">
          ...
          <p>With more than 40 years industry experience, Pat is responsible for product and marketing programs for CNW dealers across Canada.</p>
        </div>
      </div>
    </section>
    <section class="presenting-sponsor mdev-main-wrapper">
      ...
      <div class="presenting-wrapper flex flex-row flex-hor-between">
        ...
        <div class="presenting-sponsor-content">
          <p>As the RSP Awards presenting sponsor, Zucora is proud to play a role in the encouragement and development of today’s sales leaders throughout the home furnishings industry. When sales professionals go ‘above-and-beyond’ they set themselves and their businesses apart from the competition. By delivering an exceptional customer experience, sales professionals ensure that manufacturers, suppliers and retailers can all benefit by helping to grow our industry.</p>
          <div class="signature">
            <img src="/img/about/spon-sig_03.jpg" alt="" />
          </div>
          <p class="signature-text"><span class="name rsp-purple u-bold">Brad Geddes</span><br />
          President &amp; CEO, Zucora Inc.</p>
        </div>
      </div>
    </section>
