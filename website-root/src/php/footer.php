<footer>
  <div class="mdev-main-wrapper flex flex-row flex-hor-between">
    <div class="footer-contact">
      <h4 class="u-bold contact">Contact:</h4>
      <p class="email-text"><a href="mailto:info@rspawards.com">info@rspawards.com</a></p>
      <h4 class="address">Address:</h4>
      <p class="address-text">552 Clarke Road<br />
      London, ON<br />
      N5Y 5L2</p>
    </div>
    ...
    <div class="footer-social">
      <h4 class="u-bold">Join the Conversation</h4>
      <ul class="social flex flex-row">
        <li><a href="#"><img src="img/icons/icon-linked-purp.svg" alt="Linkedin" /></a></li>
        <li><a href="#"><img src="img/icons/icon-fb-purp.svg" alt="Facebook" /></a></li>
